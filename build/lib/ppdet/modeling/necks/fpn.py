...
class FPN(nn.Layer):
    ...
    def __init__(self,
        ...
        self.res_up3 = nn.Conv2D(in_channels=768, out_channels=256, kernel_size=1)
        self.res_up2 = nn.Conv2D(in_channels=512, out_channels=256, kernel_size=1)
        self.pos_embed = nn.Conv2D(768, 768, 3, padding=1, groups=384)
