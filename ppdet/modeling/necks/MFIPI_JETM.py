...
from ppdet.modeling.Decoder.TRM2.expanding_attention import DilateBlock
from ppdet.modeling.Decoder.TRM1 import TRM1RepLayer
from ppdet.modeling.Encoder.LKFWSM import LKFWSM
...
class MFIPI_JETM(nn.Layer):
    ...
    def __init__(self,
        ...
        super(MFIPI_JETM, self).__init__()
